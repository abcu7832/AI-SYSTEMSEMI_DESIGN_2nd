...
module baudrate_gen #(
    ...
    logic [$clog2(100_000_000 / BAUDRATE / 16)-1:0] br_counter;
    ...
    always_ff @(posedge clk, posedge reset) begin
        if (reset) begin
            ...
            if (br_counter == 100_000_000 / BAUDRATE / 16 - 1) begin
                br_counter <= 0;
                br_tick <= 1'b1;
            end else begin
...
module transmitter (
    ...
    logic [2:0] bit_cnt_reg, bit_cnt_next;
    logic tx_done_reg, tx_done_next, tx_busy_reg, tx_busy_next;
