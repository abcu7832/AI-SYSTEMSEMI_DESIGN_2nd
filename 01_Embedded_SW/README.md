...
![Embedded_SW](https://img.shields.io/badge/Embedded_SW-yellow)
![C](https://img.shields.io/badge/C-green)
![STM32F103](https://img.shields.io/badge/STM32F103-red)
![VSCODE](https://img.shields.io/badge/VSCODE-grey?style=flat&logo=github&logoColor=blue)

---

## 📅 수업 일정 (2025.03.25 ~ 2025.05.06)

- **03.25 ~ 03.30** : C 언어 실습  
- **03.31 ~ 04.04** : AI 실습  
- **04.07 ~ 04.18** : STM32F103 기반 임베디드 SW 실습  
- **04.21 ~ 04.25** : Machine Language 실습  
- **04.28 ~ 04.29** : 포인터 강의  
- **05.06** : 프로젝트 발표  
